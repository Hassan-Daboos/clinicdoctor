    ...
    return Scaffold(
      ...
      body: BlocConsumer<LayoutCubit,LayoutStates>(
        ...
        builder: (context,state){
          return state is !GetReservationLoadingState? layoutCubit.reservationModel.isNotEmpty? ListView.separated(
          ...
          ):Center(child: Text('There are no Reservations',style: TextStyle(color: textcolor),)):Center(child: CircularProgressIndicator());
        },
      ),
    );
  }
